...
public class IntakeWristConstants {
  ...
  public static final double intakeWristPositionTolerance = Units.degreesToRadians(1);
  public static final double intakeWristVelocityTolerance = 0.5;

  public static final double intakeWristMaxAngle = Units.degreesToRadians(0.0);
  public static final double intakeWristMinAngle = Units.degreesToRadians(80);
