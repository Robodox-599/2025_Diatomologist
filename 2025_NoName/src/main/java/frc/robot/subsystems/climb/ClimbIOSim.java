...
public class ClimbIOSim extends ClimbIO {
    ...
    public ClimbIOSim() {
        climbSim = new DCMotorSim(
            LinearSystemId.createDCMotorSystem(
                ELEVATOR_GEARBOX,
                ClimbConstants.climbMOI,
                ClimbConstants.gearRatio),
            ELEVATOR_GEARBOX);
        
        positionController = new PIDController(
            ClimbConstants.simkP,
            ClimbConstants.simkI,
            ClimbConstants.simkD
        );
        positionController.setTolerance(
            ClimbConstants.PositionToleranceInches,
            ClimbConstants.velocityToleranceInchesPerSec
        );
    }
    ...
    public void updateInputs() {
        ...
        super.velocityInchesPerSec = climbSim.getAngularAccelerationRadPerSecSq() * ClimbConstants.inchesPerRev;
