...
public class ClimbIOTalonFX extends ClimbIO {
    ...
    public void updateInputs() {
        super.positionInches = leaderMotor.getPosition().getValueAsDouble() * ClimbConstants.inchesPerRev;
        ...
        super.atSetpoint = positionError < ClimbConstants.PositionToleranceInches && 
