...
public class VisionIOSim extends VisionIOReal {
  ...
  public VisionIOSim(VisionConstants constants, Supplier<Pose2d> poseSupplier) {
    ...
    /**
     * This is framerate of our cameras when they run the calibrated resolution. Its in a general
     * range so I decided to just set it to 50 since it averages around there.
     */
